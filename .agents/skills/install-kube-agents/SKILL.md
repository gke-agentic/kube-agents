...
| `--github-app-id=ID`                    | Numeric GitHub App ID for the token minter                                                                                                                                                                                                                 |
| `--github-pem-path=PATH`                | Path to downloaded GitHub App private key (`.pem`) for initial Cloud KMS import                                                                                                                                                                            |
| `--kms-keyring=NAME`                    | Cloud KMS Key Ring name for the token minter key                                                                                                                                                                                                           |
| `--kms-key=NAME`                        | Cloud KMS CryptoKey name for the token minter signing key                                                                                                                                                                                                  |

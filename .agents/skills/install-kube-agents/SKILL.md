...
| `--cluster-mode=MODE`                | Shape of a cluster this run creates: `autopilot` \| `standard`. No bearing on an existing cluster, whose live shape the generator probes               | `autopilot`                                     |

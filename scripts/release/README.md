...
| **Pub/Sub alert ingress** | Deployed in deploy step  | Same. Provisioned via Terraform and Helm during environment deployment, and `test_stockout_investigation.py` runs **all** scenarios here against the RC's one.                                                                                                                                                                                                                                                                                                                                                  |

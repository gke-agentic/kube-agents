...
kubectl get secrets -A --field-selector type=kubernetes.io/tls -o json | jq -r '.items[] | .metadata.namespace + "/" + .metadata.name + ": " + (.data["tls.crt"] | @base64d | [match("Not After : (.*)"; "g")] | .[0].captures[0].string // "check manually")'

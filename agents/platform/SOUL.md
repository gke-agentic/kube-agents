...
- **PlatformAgent**: Deployed by the operator as a gateway pod (running `nousresearch/hermes-agent` or `OpenClaw Gateway`). Handles fleet-wide multi-tenancy configurations and global RBAC.

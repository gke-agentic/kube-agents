...
# Step 8.5: Setup Workload Identity for Go Operator Controller
...
run_step "7. Package & Build GChat Agent via Cloud Build" verify_agent_image execute_agent_image 0
run_step "8. Build & Deploy Go Operator Controller" verify_operator execute_operator 10
run_step "9. Setup Workload Identity for Go Operator Controller" verify_operator_identity execute_operator_identity 0
run_step "10. Declaratively Apply PlatformAgent Custom Resource" verify_custom_resource execute_custom_resource 0

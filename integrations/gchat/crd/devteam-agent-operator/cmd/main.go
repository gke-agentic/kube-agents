...
import (
	...
	"github.com/gke-agentic/devteam-agent-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(devteamv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2a5e5249.platform.io",

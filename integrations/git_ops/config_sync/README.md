...
_Note: This is a one-time bootstrap step. You must run these commands to enable required GCP services, create the registry, and grant appropriate storage/logging permissions to the automated Cloud Build executor._
...
1. **Submit the parallel build to Google Cloud Build**:
   ...
   _(GCP will boot up parallel builders, compile both container images concurrently in the cloud, and push them straight into your Artifact Registry!)_

...
import (
	...
	agentv1alpha1 "github.com/gke-agentic/platform-operator/api/v1alpha1"
)
...
func (r *PlatformAgentReconciler) reconcileGSA(ctx context.Context, instance *agentv1alpha1.PlatformAgent) (bool, error) {
	...
	gsa.UnstructuredContent()["spec"] = map[string]interface{}{
		"displayName": "Platform GSA for GChat: " + instance.Name,
	}
...
func (r *PlatformAgentReconciler) reconcileIAMPolicyMember(ctx context.Context, instance *agentv1alpha1.PlatformAgent, name string, resourceRef map[string]interface{}, role string, member string) (bool, error) {
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "API_SERVER_KEY",
									Value: "platform_gke_internal_api_key_392859",
								},
								{
							...
							VolumeMounts: []corev1.VolumeMount{
								{
									Name:      "platform-data-vol",
									MountPath: "/opt/data",
								},
								{
									Name:      "platform-config-vol",

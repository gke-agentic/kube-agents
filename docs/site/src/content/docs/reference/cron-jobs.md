...
| `kube-agents-maintain-and-debug` | `15,45 * * * *` | Twice hourly (:15, :45) | no | Run the kube-agents-maintain-and-debug skill: perform dynamic cluster health triage. If degraded, investiga... |

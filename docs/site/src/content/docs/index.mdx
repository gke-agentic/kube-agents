...
The recommended way to install `kube-agents` in production is from the latest official release (currently `0.4.0`):
...
Alternatively, download and extract the self-contained release archive from [GitHub Releases](https://github.com/gke-labs/kube-agents/releases/tag/0.4.0), or run the release one-liner:

...
To install via git clone, clone pinned to an official release tag:
...
Alternatively, download and extract the self-contained release archive from [GitHub Releases](https://github.com/gke-labs/kube-agents/releases).

...
| set                      | `spec.telemetry.otlpEndpoint` | the value                                   | derived from the host, or `collectorNamespace`; none for an external endpoint with `litellm.otel=true` (below) |

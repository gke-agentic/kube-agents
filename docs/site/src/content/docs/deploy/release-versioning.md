...
7. Software Bills of Materials are generated with Syft in both SPDX 2.3 JSON and CycloneDX 1.5 JSON for the filesystem assets and the container images, and published alongside `checksums.txt` with SHA256 checksums for every release asset.

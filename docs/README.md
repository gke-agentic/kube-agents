...
| `scripts/release/README.md` | Component README | Overview of Release Candidate (RC) pipeline scripts: candidate tag creation (Step 1), environment provisioning (Step 2), GKE readiness & E2E test execution (Step 3), validated tag promotion (Step 4), and the nightly staging promotion built on top of them. | Release Candidate scripts, RC automation, staging promotion | CI maintainers and release operators |

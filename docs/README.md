...
- **Runtime assets that are NOT human docs:** `agents/platform/docs/glossary.md`
  and `docs/gcp-console-links.md` are baked into the agent
...
| `docs/gcp-console-links.md`                                             | Runtime reference | GCP Console URL templates (Logs/Trace/Metrics Explorer, GKE Workloads) that agents fill with `{project_id}` to give users clickable links.                                                                                                                                                                                                                                                                                                                                                                                 | Console deep links                                                                | Baked to `/opt/defaults/docs/`                                                                                                                  |
...
| `concepts/index.mdx`                       | Site page | Card-grid hub linking the eight concept pages.                                                                                           | Navigation                                                     | —                                                                         |

...
| `scripts/release/README.md` | Component README | Overview of Release Candidate (RC) pipeline scripts: candidate tag creation (Step 1), environment provisioning (Step 2), GKE readiness & E2E test execution (Step 3), and validated tag promotion (Step 4), plus the weekly GA publication cadence. | Release Candidate scripts, RC automation, GA release cadence | CI maintainers and release operators |

...
| **Credential compromise**    | No long-lived static creds; short-lived brokered tokens via the **GitHub Token Broker (Minty)** using GCP KMS + Workload Identity (`SOUL.md §7`); cloud identity via Workload Identity, not keys                                                                                                                                                                                                    | `review-security-k8s-agents-credentials`                                                  |

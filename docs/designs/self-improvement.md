...
selfImprovement:
  ...
  # private ranges and the runner can still read its Pod and write the ledger.
  # Empty allows both GKE service-CIDR conventions (34.118.224.1, 10.96.0.1).
  apiServerCIDRs: []

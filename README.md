...
At the heart of the harness is the **Platform Agent** — the master custodian and agent architect. It is the primary chat entrypoint into the harness, manages the GKE infrastructure lifecycle, establishes multi-tenancy boundaries, and enforces fleet-wide compliance. It is driven by:

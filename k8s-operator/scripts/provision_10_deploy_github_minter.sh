...
# GITHUB_ORG and GITHUB_APP_ID are both set; skipped otherwise.
# ==============================================================================
...
execute_github_minter() {
  ...
  if [ -d "$GITHUB_INTEGRATION_DIR" ]; then
    ...
    export PROJECT_ID REGION CLUSTER_NAME NAMESPACE GITHUB_MINTER_KSA_NAME GITHUB_MINTER_GSA_NAME KMS_KEYRING KMS_KEY KMS_KEY_VERSION KMS_LOCATION GITHUB_ORG KSA_NAME PLATFORM_AGENT_GSA_NAME GITHUB_MINTER_IMAGE

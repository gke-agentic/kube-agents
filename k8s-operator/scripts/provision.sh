...
echo -e "       To deploy to cluster:"
echo -e "         ${C_WHITE}export IMG=us-central1-docker.pkg.dev/ai-platform-1-464114/k8s-harness-poc/kube-agents-operator:latest${C_RESET}"
echo -e "         ${C_WHITE}make deploy IMG=\$IMG${C_RESET}"
echo -e ""

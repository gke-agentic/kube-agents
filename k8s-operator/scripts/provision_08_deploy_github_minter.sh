...
init_var "KMS_KEYRING" "${KMS_KEYRING:-github-token-minter-keyring}" "Enter Cloud KMS Keyring Name"
init_var "KMS_KEY" "${KMS_KEY:-github-token-minter-key}" "Enter Cloud KMS Key Name"

...
- **[teardown_10_deploy_github_minter.sh](teardown_10_deploy_github_minter.sh)**: Cleans up the GitHub Token Minter deployment, GSAs, and KMS resources.
...
- **[teardown_04_gcp_iam.sh](teardown_04_gcp_iam.sh)**: Removes all GCP IAM policy bindings, Workload Identity mappings, and deletes the GSAs for the Controller and Agents.

...
3. **[provision_03_gcp_iam.sh](scripts/provision_03_gcp_iam.sh)**:
   - Pre-provisions GCP Service Accounts (GSAs) and Workload Identity bindings for the Controller and the PlatformAgent.
...
7. **[teardown_03_gcp_iam.sh](scripts/teardown_03_gcp_iam.sh)**:
   - Removes GSA project-level IAM bindings and GKE Workload Identity bindings for the Controller and PlatformAgent, and deletes their GSAs.
